 ...
 */
final class Version20250502073657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE shipment (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, consigne_id INT DEFAULT NULL, delivery_location_id INT DEFAULT NULL, loading_location_id INT DEFAULT NULL, transporteur_id INT DEFAULT NULL, type_loading_id INT DEFAULT NULL, seal_number VARCHAR(255) NOT NULL, quantity INT NOT NULL, tour_number VARCHAR(255) NOT NULL, arrival_time TIME NOT NULL COMMENT '(DC2Type:time_immutable)', departure_time TIME NOT NULL COMMENT '(DC2Type:time_immutable)', trailer_plate VARCHAR(255) NOT NULL, tractor_plate VARCHAR(255) NOT NULL, number_reference INT NOT NULL, nombre_palette INT NOT NULL, INDEX IDX_2CB20DC979B1AD6 (company_id), INDEX IDX_2CB20DC8C063686 (consigne_id), INDEX IDX_2CB20DC3A5080C8 (delivery_location_id), INDEX IDX_2CB20DC7A65737D (loading_location_id), INDEX IDX_2CB20DC97C86FA4 (transporteur_id), INDEX IDX_2CB20DCE338982D (type_loading_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
